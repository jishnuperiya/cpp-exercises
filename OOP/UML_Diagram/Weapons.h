...
{
public:
    Weapon(const std::string &_name,   // parameter names with underscore than the actual name: good coding practice
           const float _damage,
    ...
    ~Weapon() = default; // you dont also need to write it . but better to write it for better readability
