...
int main()
{
    // problem when the objects are of baseclass pointer type -- need virual destructor
    ...
    ---> Here all the derived and base class objects are destroyed
    so whenever you write classes, which can be exteneded ( with derived classes), always use virtual destructors for safety
    */
